...
get_agent_db_path = lambda: join(dirname(dirname(abspath(__file__))), __AGENT_DIR) \
    if exists(join(dirname(dirname(abspath(__file__))), __AGENT_DIR)) \
    else Exception(f'[Err] path {join(dirname(dirname(abspath(__file__))), __AGENT_DIR)} does not exists')
...
if __name__ == '__main__':
    print(get_server_db_path())
    print(get_agent_db_path())
